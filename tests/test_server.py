...
class TestBookingCompetition:
    def test_correct_competition_booking(self, client, mock_clubs, mock_competitions):
        club = [c for c in mock_clubs if c['name'] == 'Test Club One'][0]
    ...
    def test_not_enough_club_points(self, client, mock_clubs, mock_competitions):
        club = [c for c in mock_clubs if c['name'] == 'Test Club Three'][0]
        competition = [c for c in mock_competitions if c['name'] == 'Test Competition One'][0]
        places = '3'
    ...
    def test_many_places_required(self, client, mock_clubs, mock_competitions):
        club = [c for c in mock_clubs if c['name'] == 'Test Club One'][0]
        competition = [c for c in mock_competitions if c['name'] == 'Test Competition Three'][0]
        places = '3'
    ...
    def test_booking_past_competition(self, client, mock_clubs, mock_competitions):
        club = [c for c in mock_clubs if c['name'] == 'Test Club One'][0]
        competition = [c for c in mock_competitions if c['name'] == 'Test Competition Two'][0]
        places = '2'
